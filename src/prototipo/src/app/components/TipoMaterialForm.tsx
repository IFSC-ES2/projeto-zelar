  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        <Link to="/tipos-material" className="p-2 hover:bg-gray-100 rounded-lg">
          <ArrowLeft size={20} />
        </Link>
        <div>
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6">
        <form className="space-y-6">
          ...
          <div className="flex gap-4 pt-4 border-t border-gray-200">
            ...
            <Link to="/tipos-material" className="px-6 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200">Cancelar</Link>
          </div>
        </form>
      </div>
    </div>
