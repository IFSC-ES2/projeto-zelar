  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <Link to="/fornecedores/novo" className="flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">
          <Plus size={20} />
          Novo Fornecedor
        </Link>
      </div>
              ...
              <tr key={fornecedor.id} className="hover:bg-gray-50">
                ...
                <td className="px-6 py-4">
                  <div className="flex justify-end gap-2">
                    <Link to={`/fornecedores/editar/${fornecedor.id}`} className="p-2 text-blue-600 hover:bg-blue-50 rounded-lg">
                      <Edit2 size={18} />
                    </Link>
