  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <Link to="/tipos-material/novo" className="flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">
          <Plus size={20} />
          Novo Tipo
        </Link>
      </div>
              ...
              <tr key={tipo.id} className="hover:bg-gray-50">
                ...
                <td className="px-6 py-4">
                  <div className="flex justify-end gap-2">
                    <Link to={`/tipos-material/editar/${tipo.id}`} className="p-2 text-blue-600 hover:bg-blue-50 rounded-lg">
                      <Edit2 size={18} />
                    </Link>
